...
class SystemPromptBuilderTest {
    ...
    fun `buildSystemPrompt includes configured prompt and graph state`() {
        ...
        assertTrue(prompt.contains("enabled sub-agents:") && prompt.contains("repo_improvement_researcher"))
        assertTrue(prompt.contains("configured but disabled sub-agents:") && prompt.contains("personal_shopper"))
