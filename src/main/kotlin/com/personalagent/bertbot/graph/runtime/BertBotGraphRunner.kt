    ...
    fun run(
        ...
        var state =
            BertBotState(
                ...
                evidenceSources = initialState.evidenceSources.toMutableList(),
                evidenceConfidence = initialState.evidenceConfidence,
                safetyCheckResults = initialState.safetyCheckResults.toMutableList(),
                requiresUserApproval = initialState.requiresUserApproval,
                approvalReason = initialState.approvalReason,
                selectedModel = initialState.selectedModel,
                modelRoutingDecision = initialState.modelRoutingDecision,
                estimatedCostForCurrentTurn = initialState.estimatedCostForCurrentTurn,
                actualCostForCurrentTurn = initialState.actualCostForCurrentTurn,
                tokenCountingMetadata = initialState.tokenCountingMetadata,
                activeIncidents = initialState.activeIncidents.toMutableList(),
                recoveryStrategies = initialState.recoveryStrategies.toMutableList(),
                incidentLog = initialState.incidentLog.toMutableList(),
