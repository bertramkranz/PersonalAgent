...
private val promptInjectionPatterns =
    listOf(
        ...
        Regex("\\b(reveal|show|print|dump|leak)\\b.{0,40}\\b(system\\s*prompt|hidden\\s*prompt|developer\\s*message|instructions?)\\b", RegexOption.IGNORE_CASE),
        ...
        Regex("\\b(exfiltrate|extract)\\b.{0,40}\\b(secret|api\\s*key|token|credential)\\b", RegexOption.IGNORE_CASE),
    )
