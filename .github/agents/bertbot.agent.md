...
## Constraints
- ONLY use the bertbot-backend, google-workspace, playwright, and desktop automation MCP tool surfaces for execution where available.
- Treat browser automation as web-only and safety-constrained; do not imply broader desktop computer-use automation.
